...
[→ Try on khiw.dev](https://khiw.dev)

## Features

- Based on Next.js 14 (App Router, Server Actions), shadcn/ui, TailwindCSS, Vercel AI SDK.
- Uses the [E2B SDK](https://github.com/e2b-dev/code-interpreter) to securely execute code generated by AI.
- Streaming in the UI.
...
```
git clone https://github.com/getintheq/fragments.git
```
