  ...
  return (
    <div className="border border-slate-200 rounded-md bg-white overflow-hidden print:border-black">
      ...
      <button
        ...
        className="flex w-full items-center justify-between px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors print:bg-transparent print:hover:bg-transparent"
      >
      ...
      {!isVisible ? null : (
        <div className="px-3 pb-3 space-y-3">
              ...
              return (
                ...
                >
                  ...
                  <rect
                    ...
                    height={NODE_H}
                    rx={4}
                    fill={isActive ? lc.bg : 'white'}
                    stroke={isActive ? lc.border : '#e2e8f0'}
          ...
          {metrics.length > 0 && (
            <div>
              <h4 className="text-[10px] font-semibold text-slate-600 mb-1 flex items-center gap-1">
              ...
              <div className="grid gap-1.5">
                {metrics.map((m, i) => (
                  <div
                    key={`metric-${i}`}
                    className="flex items-start gap-2 rounded border border-slate-100 bg-slate-50/50 px-2 py-1.5 print:bg-transparent print:border-black/10"
                  >
                    <span className="shrink-0 text-[11px] font-bold text-indigo-600 leading-tight min-w-[100px]">
                      {m.value}
                    </span>
                    <span className="text-[10px] text-slate-600 leading-tight flex-1">
                      {m.label}
                    </span>
                    {onEvidence && m.source && (
                      <button
                        ...
                        className="shrink-0 text-amber-500 hover:text-amber-700 transition-colors print:hidden"
          ...
          {decisions.length > 0 && (
            <div>
              <h4 className="text-[10px] font-semibold text-slate-600 mb-1 flex items-center gap-1">
                <ExternalLink className="h-2.5 w-2.5 text-sky-500" />
                Technical Decisions
              </h4>
              <div className="space-y-1">
                {decisions.map((d, i) => {
                  ...
                  return (
                    <div
                      key={`decision-${i}`}
                      className="rounded border border-slate-100 bg-white print:border-black/10"
                    >
                      <button
                        type="button"
                        onClick={() =>
                        ...
                        className="flex w-full items-center gap-1.5 px-2 py-1 text-left text-[10px] font-medium text-slate-700 hover:bg-slate-50 transition-colors print:hover:bg-transparent"
                      >
                        {isExpanded ? (
