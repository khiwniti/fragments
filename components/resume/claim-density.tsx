...
export function ClaimDensityVisualizer({
  ...
  return (
    <div className="print:inline-block">
      <div className="flex items-center gap-1.5 text-[9px] text-muted-foreground-dim mb-1.5">
        ...
        {withClaims.map((section) => {
          ...
          return (
            <button
              ...
              className="flex items-center gap-2 w-full text-left cursor-pointer rounded px-1 py-0.5 transition-colors hover:bg-muted print:hover:bg-transparent"
              tabIndex={0}
              role="button"
            ...
            >
              ...
              {/* Bar track */}
              <div className="flex-1 h-2.5 rounded-full bg-muted overflow-hidden max-w-[140px]">
                <div
              ...
              <span
                className={`w-16 text-right text-[9px] font-medium transition-colors ${
                  isHovered ? 'text-primary' : 'text-muted-foreground-dim'
                }`}
              >
      ...
      <p className="text-[8px] text-muted-foreground-dim mt-1.5 italic">
