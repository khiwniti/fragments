...
export function ContributionHeatmap({
  ...
  return (
    <div className="print:inline-block">
      {/* ── Stats row ───────────────────────────────────────────────── */}
      <div className="flex flex-wrap items-center gap-4 mb-2.5 text-[10px] text-slate-600 print:text-[9px] print:text-black">
      ...
      {/* ── Legend ──────────────────────────────────────────────────── */}
      <div className="flex items-center justify-end gap-1 mt-1 text-[9px] text-slate-400 print:text-[8px] print:text-black/60">
        <span>Less</span>
        {[0, 1, 3, 8, 16].map((n) => (
          <span
            key={n}
