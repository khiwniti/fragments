  ...
  return (
    <div className="print:inline-block">
      <div className="relative">
        {/* Vertical line */}
        <div
          className="absolute left-[5px] top-3 bottom-3 w-0.5 bg-slate-200 print:bg-black/20"
          aria-hidden="true"
        />
        ...
        <div className="space-y-3 relative">
          {sorted.map((cred, i) => {
            ...
            const dotColor = isDegree ? '#6366f1' : '#f59e0b'
                ...
                <div className="flex-1 min-w-0 pb-0.5">
                  {onSelect ? (
                    <button
                      ...
                      className="block w-full text-left cursor-pointer hover:ring-1 hover:ring-slate-300 rounded-sm print:ring-0"
                    >
