...
- Name: home.spec.ts >> Landing Page — Full E2E >> Footer >> renders footer with credit text
- Location: e2e/home.spec.ts:227:9

# Error details

```
Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: locator('text=AI-Augmented Full-Stack Developer') resolved to 3 elements:
    ...
    3) <p class="text-[11px] text-muted-foreground font-mono">Built by Khiw (Ikkyu) Nitithadachot · AI-Augmente…</p> aka getByText('Built by Khiw (Ikkyu)')

Call log:
  - waiting for locator('text=AI-Augmented Full-Stack Developer')
