...
- Name: home.spec.ts >> Landing Page — Full E2E >> Career Section >> shows Education section
- Location: e2e/home.spec.ts:174:9
...
Locator: getByText('Education')
Expected: visible
Error: strict mode violation: getByText('Education') resolved to 2 elements:
    1) <div class="text-[13px] text-primary font-bold">Education</div> aka getByText('Education', { exact: true })
    2) <span class="text-[11px] text-muted-foreground italic truncate">Free STEM Education for Thailand</span> aka getByRole('button', { name: 'kidpen.org — Free STEM' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Education')
